class Encounter
    attr_reader :art # our sweet sweet asci art
    attr_reader :name # The name of the encounter, duh!
    attr_reader :options # The options, the player choses!
    attr_reader :consequences # The concequence of the players choice of options
